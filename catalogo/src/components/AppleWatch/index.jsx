    ...
    titles.forEach(function(title) {
        ...
        if (window.innerWidth <= 853) { // Verifica se é uma tela grande
            if (scrollPosition > (titleOffsetTop - windowHeight * 0.75)) { // Atrasa o início do efeito de scroll
                ...
                title.style.fontSize = '27pt'; // Tamanho maior para dispositivos maiores que 853px
            }
        } else { // Se for uma tela pequena (como dispositivos móveis)
            title.style.fontSize = '27pt'; // Mantém o tamanho da fonte inalterado
        }
    });
});
            ...
            <div className="row">
                <div className="col selo d-flex justify-content-center">
                    <div className="row text-center ">
                        ...
                        <span className='col  d-flex align-items-center'>Garantia<br />Apple 1 ano</span>
                    </div>
                </div>
                
            </div>
            <a href={wpp} type="button" className="btn btn-price btn-outline-light button-wpp mt-2 mb-2 ">
